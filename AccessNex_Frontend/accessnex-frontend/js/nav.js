/* Injects topnav + sidebar and highlights active nav item */
  ...
  const navHTML = `
    ...
    <aside class="sidebar">
      ...
      <a class="nav-item ${activePage === 'access' ? 'active' : ''}" href="access.html">
        <svg viewBox="0 0 24 24"><path d="M15 3H5a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-8"/><polyline points="15 3 21 3 21 9"/><line x1="10" y1="14" x2="21" y2="3"/></svg>
        Access log
      </a>
